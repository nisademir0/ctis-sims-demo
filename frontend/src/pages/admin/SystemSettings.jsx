...
export default function SystemSettings() {
  ...
  const loadSettings = async () => {
    try {
      setLoading(true);
      const data = await getSettingsByCategory('ai');
      
      // Backend returns: { settings: { 'chatbot.enabled': { value: true, type: 'boolean', ... } } }
      const settingsObj = data.settings || {};
      
      // Extract values from settings object
      const extractedSettings = {};
      Object.keys(settingsObj).forEach(key => {
        extractedSettings[key] = settingsObj[key].value;
      });
      
      console.log('Loaded settings:', extractedSettings);
      setAiSettings(extractedSettings);
    } catch (error) {
      toast.error(t('admin.ayarlar_y_klenemedi'));
  ...
  const handleSave = async () => {
    try {
      ...
      // Backend expects: { settings: { 'chatbot.enabled': value, ... } }
    ...
    <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100">Chatbot Etkin</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                AI Chatbot'u sistem genelinde etkinleştir/devre dışı bırak
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="border-t pt-6">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                type="button"
                data-testid="chatbot-staff-access-toggle"
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                type="button"
                data-testid="chatbot-manager-access-toggle"
      ...
      <Card title="ℹ️ Bilgi" variant="info">
        <div className="text-sm text-gray-700 space-y-2 dark:text-gray-300">
          <p>
            <strong>Chatbot Etkin:</strong> Global anahtar. Kapalıyken hiçbir kullanıcı erişemez.
          </p>
          <p>
